...
class MusicService: Service() {
    ...
    //Created
    fun changeMusic(music: Int, a: Int, b: Int, c: Int, x: Int, y: Int, z: Int)   {
        musicPlayer?.changeMusic(music)
        musicPlayer?.changeEffect1(a)
        musicPlayer?.changeEffect2(b)
        musicPlayer?.changeEffect3(c)
        musicPlayer?.seeker1(x)
        musicPlayer?.seeker2(y)
        musicPlayer?.seeker3(z)
    }
